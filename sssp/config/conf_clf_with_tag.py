...
def init_arguments(parser):
    # MODEL
    parser.add_argument('--model_path', type=str, default='sssp.models.clf.basic_clf_with_tag', help='model_path')
    ...
    parser.add_argument('--use_tag', action='store_true', default=False, help='if use tag')
    ...
    parser.add_argument('--train_embd', action='store_true', default=True, help='If train embedding')
    ...
    parser.add_argument('--num_tags', type=int, default=2, help='number of labels of tags')
