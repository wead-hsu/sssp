...
def init_arguments(parser):
    # MODEL
    parser.add_argument('--model_path', type=str, default='sssp.models.semiclf', help='model_path')
    ...
    parser.add_argument('--alpha', type=float, default=3.0, help='rescale for unlabeled clf')
    parser.add_argument('--num_pretrain_steps', type=int, default=2000, help='Number of step for pretraining')
    ...
    parser.add_argument('--validate_every', type=int, default=2000, help='Number of batch between validating the results')
    ...
    parser.add_argument('--save_dir', type=str, default='results/semiclf', help='Directory for saving')
    ...
    #parser.add_argument('--init_from', type=str, default='results/semiclf/semiclf-30', help='Restore from the trained model path')
