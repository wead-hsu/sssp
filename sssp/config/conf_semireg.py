...
def init_arguments(parser):
    # MODEL
    parser.add_argument('--model_path', type=str, default='sssp.models.semireg.semireg', help='model_path')
    parser.add_argument('--model_name', type=str, default='SemiRegression', help='model_name')
    ...
    parser.add_argument('--use_sampled_softmax', type=bool, default=False, help='If use sampled_softmax to speed up')
    ...
    parser.add_argument('--num_pretrain_steps', type=int, default=3000, help='Number of step for pretraining')
    ...
    # DATASET
    parser.add_argument('--train_label_path', type=str, default='data/beer/proc/cls_0-aspect_1/labeled.data.idx', help='Directory of datasets')
    parser.add_argument('--train_unlabel_path', type=str, default='data/beer/proc/cls_0-aspect_1/unlabeled.data.idx', help='Directory of datasets')
    parser.add_argument('--valid_path', type=str, default='data/beer/proc/cls_0-aspect_1/dev.data.idx', help='Directory of datasets')
    parser.add_argument('--test_path', type=str, default='data/beer/proc/cls_0-aspect_1/test.data.idx', help='Directory of datasets')
    parser.add_argument('--vocab_path', type=str, default='data/case_type_clf/proc/vocab.pkl', help='vocab_path')
    parser.add_argument('--save_dir', type=str, default='results/semireg', help='Directory for saving')
    parser.add_argument('--log_prefix', type=str, default='semireg', help='Log prefix')
