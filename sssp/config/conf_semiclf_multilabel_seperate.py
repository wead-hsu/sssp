...
def init_arguments(parser):
    # MODEL
    parser.add_argument('--model_path', type=str, default='sssp.models.semiclf.multilabel_semiclf_sample_seperate', help='model_path')
    ...
    parser.add_argument('--save_every', type=int, default=-1, help='Number of batch between saving the results')
    ...
    if dataset == 'gongshang':
        ...
        parser.add_argument('--task_id', type=int, default=8, help='task id')
        ...
        parser.add_argument('--train_path', type=str, default='data/gongshang/semi3k/labeled.data.idx', help='Directory of datasets')
        parser.add_argument('--train_label_path', type=str, default='data/gongshang/semi3k/labeled.data.idx', help='Directory of datasets')
        parser.add_argument('--train_unlabel_path', type=str, default='data/gongshang/semi3k/unlabeled.data.idx', help='Directory of datasets')
        parser.add_argument('--valid_path', type=str, default='data/gongshang/semi3k/valid.data.idx', help='Directory of datasets')
        parser.add_argument('--test_path', type=str, default='data/gongshang/semi3k/test.data.idx', help='Directory of datasets')
        parser.add_argument('--vocab_path', type=str, default='data/gongshang/semi3k/labeled.data.idx', help='vocab_path')
        parser.add_argument('--save_dir', type=str, default='results/tmp', help='Directory for saving')
        parser.add_argument('--klw_w', type=float, default=3e-5, help='klw = klw_w * step + klw_b')
        parser.add_argument('--klw_b', type=float, default=3e5, help='klw = klw_w * step + klw_b')
        #parser.add_argument('--init_from', type=str, default='results/semiclf/semiclf-8000', help='Restore from the trained model path')
